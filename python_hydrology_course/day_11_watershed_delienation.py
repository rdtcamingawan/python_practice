...
point_save_path = r"C:\Users\richmond\Downloads\testing\shps\pour_point.shp"
fig_save_path = r"C:\Users\richmond\Downloads\testing\watershed_delineation.png"
...
wbe.write_raster(flow_accum,
                 r"C:\Users\richmond\Downloads\testing\wbt_flow_accum.tif")
...
wbe.write_vector(watershed_vec, 'watershed.gpkg') # save to file
...
# wbe.write_vector(streams_vec, 'streams.gpkg') # save to file
